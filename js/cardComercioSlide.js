...
export function crearCardComercioSlide(comercio) {
  ...
  card.innerHTML = `
    ...
    <div class="w-full h-24 relative bg-gray-200">
      ...
      <!-- Logo circular -->
      <div class="absolute -bottom-5 left-1/2 transform -translate-x-1/2 w-10 h-10 bg-white border-2 border-white rounded-full shadow overflow-hidden">
    ...
    <div class="pt-6 px-2 pb-2 text-center">
      ...
      <p class="text-xs text-gray-500 truncate">${subcategoria}</p>
