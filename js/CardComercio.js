export function cardComercio(comercio) {
  ...
  // Estilo general del card con ajuste de ancho máximo y centrado
  div.className = `
    bg-white w-full max-w-[340px] mx-auto rounded-2xl shadow-md overflow-hidden 
    ...
    <div class="relative">
      ...
      <a href="tel:${comercio.telefono}" 
        class="inline-flex items-center justify-center gap-2 text-lg text-white font-normal bg-red-600 
               rounded-full px-4 py-1 mb-2 shadow hover:bg-red-700 transition mx-auto mt-2">
